...
class MainActivity : AppCompatActivity() {
    ...
    private lateinit var recyclerViewPelicula: RecyclerView
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        //bindeo
        recyclerViewPelicula = findViewById(R.id.recyclerViewPeliculas)
        recyclerViewPelicula.layoutManager = LinearLayoutManager(this)
// La línea que divide los elementos
        recyclerViewPelicula.addItemDecoration(
        ...
        val adaptadorRecyclerView = AdaptadorPelicula(peliculas)

        // El adaptador que se encarga de toda la lógica
        recyclerViewPelicula.setAdapter(adaptadorRecyclerView)

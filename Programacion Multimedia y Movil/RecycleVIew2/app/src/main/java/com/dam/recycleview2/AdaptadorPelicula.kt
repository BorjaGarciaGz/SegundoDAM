...
class AdaptadorPelicula(datosPelis: MutableList<Pelicula>) : RecyclerView.Adapter<ViewHolderPelicula>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolderPelicula {
        ...
        val vista: View = LayoutInflater.from(parent.context).inflate(R.layout.filaPelicula, parent, false)
